...
public enum CommandType {
  ...
  ADD_SHOPPING_CART_ITEM_FROM_MARKETPLACE(new AddShoppingCartItemFromMarketplaceCommand()),
  ADD_SHOPPING_CART_ITEM_FROM_CART(new AddShoppingCartItemFromCartCommand()),
